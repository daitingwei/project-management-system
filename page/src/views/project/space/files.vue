                    ...
                    <div class="list-content">
                        ...
                        >
                            ...
                            <a-list-item class="list-item" :key="index" v-for="(item, index) in files">
                                <a-list-item-meta>
                                    <a-avatar slot="avatar" shape="square" icon="link" :src="'/project/file/download?fileCode=' + item.code"/>
                                    <div slot="title">
                                        <a-tooltip :mouseEnterDelay="0.3">
                                            ...
                                            <a class="text-default" target="_blank" :href="item | showPreviewUrl"
                                               v-show="!item.editing">{{item.fileName}}{{item.extension}}</a>
                                        </a-tooltip>
                                    </div>
                                </a-list-item-meta>
                                <div class="other-info muted">
                                ...
                                <span slot="actions">
                                    <a-tooltip title="下载">
                                        <a class="muted" @click="downloadFile(item)"><a-icon type="download"/></a>
                                    </a-tooltip>
                                </span>
                                <!-- <span slot="actions">
                                     <a-tooltip title="更新">
    ...
    export default {
        ...
        methods: {
            ...
            onCellChange(file) {
                ...
                if (newFileName != currentFile.fileName) {
                    edit({title: currentFile.fileName, fileCode: currentFile.code}).then(res => {
