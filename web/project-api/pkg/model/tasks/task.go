...
type TaskSortReq struct {
	PreTaskCode  string `form:"preTaskCode" json:"preTaskCode"`
	NextTaskCode string `form:"nextTaskCode" json:"nextTaskCode"`
	ToStageCode  string `form:"toStageCode" json:"toStageCode"`
}
