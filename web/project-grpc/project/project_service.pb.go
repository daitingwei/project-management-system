...
type ProjectRpcMessage struct {
	...
	MemberCode       string                 `protobuf:"bytes,16,opt,name=memberCode,proto3" json:"memberCode,omitempty"`
	InviteCode       string                 `protobuf:"bytes,17,opt,name=inviteCode,proto3" json:"inviteCode,omitempty"`
	Cover            string                 `protobuf:"bytes,18,opt,name=cover,proto3" json:"cover,omitempty"`
...
func (x *ProjectRpcMessage) GetMemberCode() string {
	if x != nil {
		return x.MemberCode
	}
	return ""
...
func (x *ProjectRpcMessage) GetInviteCode() string {
	if x != nil {
		return x.InviteCode
	}
	return ""
...
func (x *ProjectRpcMessage) GetCover() string {
	if x != nil {
		return x.Cover
	}
	return ""
...
func (x *ProjectRpcMessage) GetCode() string {
	if x != nil {
		return x.Code
	}
	return ""
...
type QuitProjectResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *QuitProjectResponse) Reset() {
	*x = QuitProjectResponse{}
	mi := &file_project_service_proto_msgTypes[14]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *QuitProjectResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*QuitProjectResponse) ProtoMessage() {}

func (x *QuitProjectResponse) ProtoReflect() protoreflect.Message {
	mi := &file_project_service_proto_msgTypes[14]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use QuitProjectResponse.ProtoReflect.Descriptor instead.
func (*QuitProjectResponse) Descriptor() ([]byte, []int) {
...
type RecoveryArchiveResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *RecoveryArchiveResponse) Reset() {
	*x = RecoveryArchiveResponse{}
	mi := &file_project_service_proto_msgTypes[16]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *RecoveryArchiveResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RecoveryArchiveResponse) ProtoMessage() {}

func (x *RecoveryArchiveResponse) ProtoReflect() protoreflect.Message {
	mi := &file_project_service_proto_msgTypes[16]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RecoveryArchiveResponse.ProtoReflect.Descriptor instead.
func (*RecoveryArchiveResponse) Descriptor() ([]byte, []int) {
...
type ProjectBoolResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
...
func (x *ProjectBoolResponse) Reset() {
	*x = ProjectBoolResponse{}
	mi := &file_project_service_proto_msgTypes[18]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ProjectBoolResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ProjectBoolResponse) ProtoMessage() {}

func (x *ProjectBoolResponse) ProtoReflect() protoreflect.Message {
	mi := &file_project_service_proto_msgTypes[18]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ProjectBoolResponse.ProtoReflect.Descriptor instead.
func (*ProjectBoolResponse) Descriptor() ([]byte, []int) {
	return file_project_service_proto_rawDescGZIP(), []int{18}
}

func (x *ProjectBoolResponse) GetOk() bool {
	if x != nil {
		return x.Ok
	}
	return false
...
func (x *ProjectAnalysisResponse) Reset() {
	*x = ProjectAnalysisResponse{}
	mi := &file_project_service_proto_msgTypes[19]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ProjectAnalysisResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ProjectAnalysisResponse) ProtoMessage() {}

func (x *ProjectAnalysisResponse) ProtoReflect() protoreflect.Message {
	mi := &file_project_service_proto_msgTypes[19]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ProjectAnalysisResponse.ProtoReflect.Descriptor instead.
func (*ProjectAnalysisResponse) Descriptor() ([]byte, []int) {
	return file_project_service_proto_rawDescGZIP(), []int{19}
}

type SearchInviteMemberResponse struct {
	state         protoimpl.MessageState  `protogen:"open.v1"`
	List          []*ProjectMemberMessage `protobuf:"bytes,1,rep,name=list,proto3" json:"list,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *SearchInviteMemberResponse) Reset() {
	*x = SearchInviteMemberResponse{}
	mi := &file_project_service_proto_msgTypes[20]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *SearchInviteMemberResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SearchInviteMemberResponse) ProtoMessage() {}

func (x *SearchInviteMemberResponse) ProtoReflect() protoreflect.Message {
	mi := &file_project_service_proto_msgTypes[20]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SearchInviteMemberResponse.ProtoReflect.Descriptor instead.
func (*SearchInviteMemberResponse) Descriptor() ([]byte, []int) {
	return file_project_service_proto_rawDescGZIP(), []int{20}
}

func (x *SearchInviteMemberResponse) GetList() []*ProjectMemberMessage {
	if x != nil {
		return x.List
	}
	return nil
...
func (x *ProjectMemberMessage) GetAvatar() string {
	if x != nil {
		return x.Avatar
	}
	return ""
...
func (x *ProjectMemberMessage) GetEmail() string {
	if x != nil {
		return x.Email
	}
	return ""
...
func (x *ProjectMemberMessage) GetJoined() bool {
	if x != nil {
		return x.Joined
	}
	return false
...
type JoinByInviteLinkResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *JoinByInviteLinkResponse) Reset() {
	*x = JoinByInviteLinkResponse{}
	mi := &file_project_service_proto_msgTypes[23]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *JoinByInviteLinkResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*JoinByInviteLinkResponse) ProtoMessage() {}

func (x *JoinByInviteLinkResponse) ProtoReflect() protoreflect.Message {
	mi := &file_project_service_proto_msgTypes[23]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use JoinByInviteLinkResponse.ProtoReflect.Descriptor instead.
func (*JoinByInviteLinkResponse) Descriptor() ([]byte, []int) {
	return file_project_service_proto_rawDescGZIP(), []int{23}
}
...
func (x *RemoveMemberResponse) Reset() {
	*x = RemoveMemberResponse{}
	mi := &file_project_service_proto_msgTypes[24]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*RemoveMemberResponse) Descriptor() ([]byte, []int) {
	return file_project_service_proto_rawDescGZIP(), []int{24}
}

type ListForInviteResponse struct {
	state         protoimpl.MessageState  `protogen:"open.v1"`
	List          []*ProjectMemberMessage `protobuf:"bytes,1,rep,name=list,proto3" json:"list,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
...
func (x *ListForInviteResponse) Reset() {
	*x = ListForInviteResponse{}
	mi := &file_project_service_proto_msgTypes[25]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ListForInviteResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ListForInviteResponse) ProtoMessage() {}

func (x *ListForInviteResponse) ProtoReflect() protoreflect.Message {
	mi := &file_project_service_proto_msgTypes[25]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ListForInviteResponse.ProtoReflect.Descriptor instead.
func (*ListForInviteResponse) Descriptor() ([]byte, []int) {
	return file_project_service_proto_rawDescGZIP(), []int{25}
}

func (x *ListForInviteResponse) GetList() []*ProjectMemberMessage {
	if x != nil {
		return x.List
	}
	return nil
...
func (x *UpdateProjectMessage) Reset() {
	*x = UpdateProjectMessage{}
	mi := &file_project_service_proto_msgTypes[26]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*UpdateProjectMessage) Descriptor() ([]byte, []int) {
	return file_project_service_proto_rawDescGZIP(), []int{26}
}
...
func (x *ProjectLogMessage) Reset() {
	*x = ProjectLogMessage{}
	mi := &file_project_service_proto_msgTypes[27]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ProjectLogMessage) Descriptor() ([]byte, []int) {
	return file_project_service_proto_rawDescGZIP(), []int{27}
}
...
func (x *ProjectLogResponse) Reset() {
	*x = ProjectLogResponse{}
	mi := &file_project_service_proto_msgTypes[28]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ProjectLogResponse) Descriptor() ([]byte, []int) {
	return file_project_service_proto_rawDescGZIP(), []int{28}
}
...
func (x *ProjectNodeMessage) Reset() {
	*x = ProjectNodeMessage{}
	mi := &file_project_service_proto_msgTypes[29]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ProjectNodeMessage) Descriptor() ([]byte, []int) {
	return file_project_service_proto_rawDescGZIP(), []int{29}
}
...
func (x *ProjectNodeResponseMessage) Reset() {
	*x = ProjectNodeResponseMessage{}
	mi := &file_project_service_proto_msgTypes[30]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ProjectNodeResponseMessage) Descriptor() ([]byte, []int) {
	return file_project_service_proto_rawDescGZIP(), []int{30}
}
...
func (x *FindProjectByMemberIdResponse) Reset() {
	*x = FindProjectByMemberIdResponse{}
	mi := &file_project_service_proto_msgTypes[31]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*FindProjectByMemberIdResponse) Descriptor() ([]byte, []int) {
	return file_project_service_proto_rawDescGZIP(), []int{31}
}
...
const file_project_service_proto_rawDesc = "" +
	...
	"\tcollected\x18  \x01(\x05R\tcollected\"\xec\x06\n" +
	...
	"\vownerAvatar\x18\x1c \x01(\tR\vownerAvatar\"\xf8\x01\n" +
	...
	"\x10OrganizationCode\x18\b \x01(\tR\x10OrganizationCode\"\xb1\x04\n" +
	...
	"\btaskCode\x18\x0f \x01(\tR\btaskCode\x12\x1e\n" +
	"\n" +
	"memberCode\x18\x10 \x01(\tR\n" +
	"memberCode\x12\x1e\n" +
	"\n" +
	"inviteCode\x18\x11 \x01(\tR\n" +
	"inviteCode\x12\x14\n" +
	"\x05cover\x18\x12 \x01(\tR\x05cover\x12\x12\n" +
	"\x04Code\x18\x13 \x01(\tR\x04Code\"\xe4\x02\n" +
	...
	"\x15UpdateProjectResponse\"\x15\n" +
	"\x13QuitProjectResponse\"\x18\n" +
	"\x16ArchiveProjectResponse\"\x19\n" +
	"\x17RecoveryArchiveResponse\"\x17\n" +
	"\x15DeleteProjectResponse\"%\n" +
	"\x13ProjectBoolResponse\x12\x0e\n" +
	"\x02ok\x18\x01 \x01(\bR\x02ok\"\x19\n" +
	"\x17ProjectAnalysisResponse\"Z\n" +
	"\x1aSearchInviteMemberResponse\x12<\n" +
	"\x04list\x18\x01 \x03(\v2(.project.service.v1.ProjectMemberMessageR\x04list\"|\n" +
	"\x14ProjectMemberMessage\x12\x0e\n" +
	...
	"\x14InviteMemberResponse\"\x1a\n" +
	"\x18JoinByInviteLinkResponse\"\x16\n" +
	"\x14RemoveMemberResponse\"U\n" +
	"\x15ListForInviteResponse\x12<\n" +
	"\x04list\x18\x01 \x03(\v2(.project.service.v1.ProjectMemberMessageR\x04list\"\xb6\x03\n" +
	...
	"\aisOwner\x18\x03 \x01(\bR\aisOwner2\xc5\x13\n" +
	...
	"\x13FindProjectTemplate\x12%.project.service.v1.ProjectRpcMessage\x1a+.project.service.v1.ProjectTemplateResponse\"\x00\x12j\n" +
	"\x13SaveProjectTemplate\x12%.project.service.v1.ProjectRpcMessage\x1a*.project.service.v1.ProjectTemplateMessage\"\x00\x12i\n" +
	"\x15UpdateProjectTemplate\x12%.project.service.v1.ProjectRpcMessage\x1a'.project.service.v1.ProjectBoolResponse\"\x00\x12i\n" +
	"\x15DeleteProjectTemplate\x12%.project.service.v1.ProjectRpcMessage\x1a'.project.service.v1.ProjectBoolResponse\"\x00\x12^\n" +
	"\vSaveProject\x12%.project.service.v1.ProjectRpcMessage\x1a&.project.service.v1.SaveProjectMessage\"\x00\x12f\n" +
	"\x11FindProjectDetail\x12%.project.service.v1.ProjectRpcMessage\x1a(.project.service.v1.ProjectDetailMessage\"\x00\x12k\n" +
	"\x14UpdateDeletedProject\x12%.project.service.v1.ProjectRpcMessage\x1a*.project.service.v1.DeletedProjectResponse\"\x00\x12k\n" +
	...
	"\x15FindProjectByMemberId\x12%.project.service.v1.ProjectRpcMessage\x1a1.project.service.v1.FindProjectByMemberIdResponse\"\x00\x12_\n" +
	"\vQuitProject\x12%.project.service.v1.ProjectRpcMessage\x1a'.project.service.v1.QuitProjectResponse\"\x00\x12e\n" +
	"\x0eArchiveProject\x12%.project.service.v1.ProjectRpcMessage\x1a*.project.service.v1.ArchiveProjectResponse\"\x00\x12g\n" +
	"\x0fRecoveryArchive\x12%.project.service.v1.ProjectRpcMessage\x1a+.project.service.v1.RecoveryArchiveResponse\"\x00\x12c\n" +
	"\rDeleteProject\x12%.project.service.v1.ProjectRpcMessage\x1a).project.service.v1.DeleteProjectResponse\"\x00\x12g\n" +
	"\x0fProjectAnalysis\x12%.project.service.v1.ProjectRpcMessage\x1a+.project.service.v1.ProjectAnalysisResponse\"\x00\x12m\n" +
	"\x12SearchInviteMember\x12%.project.service.v1.ProjectRpcMessage\x1a..project.service.v1.SearchInviteMemberResponse\"\x00\x12a\n" +
	"\fInviteMember\x12%.project.service.v1.ProjectRpcMessage\x1a(.project.service.v1.InviteMemberResponse\"\x00\x12i\n" +
	"\x10JoinByInviteLink\x12%.project.service.v1.ProjectRpcMessage\x1a,.project.service.v1.JoinByInviteLinkResponse\"\x00\x12a\n" +
	"\fRemoveMember\x12%.project.service.v1.ProjectRpcMessage\x1a(.project.service.v1.RemoveMemberResponse\"\x00\x12c\n" +
	"\rListForInvite\x12%.project.service.v1.ProjectRpcMessage\x1a).project.service.v1.ListForInviteResponse\"\x00B\x1fZ\x1dtest.com/project-grpc/projectb\x06proto3"
...
var file_project_service_proto_msgTypes = make([]protoimpl.MessageInfo, 32)
var file_project_service_proto_goTypes = []any{
	...
	(*QuitProjectResponse)(nil),           // 14: project.service.v1.QuitProjectResponse
	(*ArchiveProjectResponse)(nil),        // 15: project.service.v1.ArchiveProjectResponse
	(*RecoveryArchiveResponse)(nil),       // 16: project.service.v1.RecoveryArchiveResponse
	(*DeleteProjectResponse)(nil),         // 17: project.service.v1.DeleteProjectResponse
	(*ProjectBoolResponse)(nil),           // 18: project.service.v1.ProjectBoolResponse
	(*ProjectAnalysisResponse)(nil),       // 19: project.service.v1.ProjectAnalysisResponse
	(*SearchInviteMemberResponse)(nil),    // 20: project.service.v1.SearchInviteMemberResponse
	(*ProjectMemberMessage)(nil),          // 21: project.service.v1.ProjectMemberMessage
	(*InviteMemberResponse)(nil),          // 22: project.service.v1.InviteMemberResponse
	(*JoinByInviteLinkResponse)(nil),      // 23: project.service.v1.JoinByInviteLinkResponse
	(*RemoveMemberResponse)(nil),          // 24: project.service.v1.RemoveMemberResponse
	(*ListForInviteResponse)(nil),         // 25: project.service.v1.ListForInviteResponse
	(*UpdateProjectMessage)(nil),          // 26: project.service.v1.UpdateProjectMessage
	(*ProjectLogMessage)(nil),             // 27: project.service.v1.ProjectLogMessage
	(*ProjectLogResponse)(nil),            // 28: project.service.v1.ProjectLogResponse
	(*ProjectNodeMessage)(nil),            // 29: project.service.v1.ProjectNodeMessage
	(*ProjectNodeResponseMessage)(nil),    // 30: project.service.v1.ProjectNodeResponseMessage
	(*FindProjectByMemberIdResponse)(nil), // 31: project.service.v1.FindProjectByMemberIdResponse
}
var file_project_service_proto_depIdxs = []int32{
	...
	21, // 5: project.service.v1.SearchInviteMemberResponse.list:type_name -> project.service.v1.ProjectMemberMessage
	21, // 6: project.service.v1.ListForInviteResponse.list:type_name -> project.service.v1.ProjectMemberMessage
	27, // 7: project.service.v1.ProjectLogResponse.list:type_name -> project.service.v1.ProjectLogMessage
	29, // 8: project.service.v1.ProjectNodeMessage.children:type_name -> project.service.v1.ProjectNodeMessage
	29, // 9: project.service.v1.ProjectNodeResponseMessage.nodes:type_name -> project.service.v1.ProjectNodeMessage
	3,  // 10: project.service.v1.FindProjectByMemberIdResponse.project:type_name -> project.service.v1.ProjectMessage
	0,  // 11: project.service.v1.ProjectService.Index:input_type -> project.service.v1.IndexMessage
	6,  // 12: project.service.v1.ProjectService.FindProjectByMemId:input_type -> project.service.v1.ProjectRpcMessage
	6,  // 13: project.service.v1.ProjectService.FindProjectTemplate:input_type -> project.service.v1.ProjectRpcMessage
	6,  // 14: project.service.v1.ProjectService.SaveProjectTemplate:input_type -> project.service.v1.ProjectRpcMessage
	6,  // 15: project.service.v1.ProjectService.UpdateProjectTemplate:input_type -> project.service.v1.ProjectRpcMessage
	6,  // 16: project.service.v1.ProjectService.DeleteProjectTemplate:input_type -> project.service.v1.ProjectRpcMessage
	6,  // 17: project.service.v1.ProjectService.SaveProject:input_type -> project.service.v1.ProjectRpcMessage
	6,  // 18: project.service.v1.ProjectService.FindProjectDetail:input_type -> project.service.v1.ProjectRpcMessage
	6,  // 19: project.service.v1.ProjectService.UpdateDeletedProject:input_type -> project.service.v1.ProjectRpcMessage
	6,  // 20: project.service.v1.ProjectService.UpdateCollectProject:input_type -> project.service.v1.ProjectRpcMessage
	26, // 21: project.service.v1.ProjectService.UpdateProject:input_type -> project.service.v1.UpdateProjectMessage
	6,  // 22: project.service.v1.ProjectService.GetLogBySelfProject:input_type -> project.service.v1.ProjectRpcMessage
	6,  // 23: project.service.v1.ProjectService.NodeList:input_type -> project.service.v1.ProjectRpcMessage
	6,  // 24: project.service.v1.ProjectService.FindProjectByMemberId:input_type -> project.service.v1.ProjectRpcMessage
	6,  // 25: project.service.v1.ProjectService.QuitProject:input_type -> project.service.v1.ProjectRpcMessage
	6,  // 26: project.service.v1.ProjectService.ArchiveProject:input_type -> project.service.v1.ProjectRpcMessage
	6,  // 27: project.service.v1.ProjectService.RecoveryArchive:input_type -> project.service.v1.ProjectRpcMessage
	6,  // 28: project.service.v1.ProjectService.DeleteProject:input_type -> project.service.v1.ProjectRpcMessage
	6,  // 29: project.service.v1.ProjectService.ProjectAnalysis:input_type -> project.service.v1.ProjectRpcMessage
	6,  // 30: project.service.v1.ProjectService.SearchInviteMember:input_type -> project.service.v1.ProjectRpcMessage
	6,  // 31: project.service.v1.ProjectService.InviteMember:input_type -> project.service.v1.ProjectRpcMessage
	6,  // 32: project.service.v1.ProjectService.JoinByInviteLink:input_type -> project.service.v1.ProjectRpcMessage
	6,  // 33: project.service.v1.ProjectService.RemoveMember:input_type -> project.service.v1.ProjectRpcMessage
	6,  // 34: project.service.v1.ProjectService.ListForInvite:input_type -> project.service.v1.ProjectRpcMessage
	2,  // 35: project.service.v1.ProjectService.Index:output_type -> project.service.v1.IndexResponse
	10, // 36: project.service.v1.ProjectService.FindProjectByMemId:output_type -> project.service.v1.MyProjectResponse
	9,  // 37: project.service.v1.ProjectService.FindProjectTemplate:output_type -> project.service.v1.ProjectTemplateResponse
	7,  // 38: project.service.v1.ProjectService.SaveProjectTemplate:output_type -> project.service.v1.ProjectTemplateMessage
	18, // 39: project.service.v1.ProjectService.UpdateProjectTemplate:output_type -> project.service.v1.ProjectBoolResponse
	18, // 40: project.service.v1.ProjectService.DeleteProjectTemplate:output_type -> project.service.v1.ProjectBoolResponse
	5,  // 41: project.service.v1.ProjectService.SaveProject:output_type -> project.service.v1.SaveProjectMessage
	4,  // 42: project.service.v1.ProjectService.FindProjectDetail:output_type -> project.service.v1.ProjectDetailMessage
	11, // 43: project.service.v1.ProjectService.UpdateDeletedProject:output_type -> project.service.v1.DeletedProjectResponse
	12, // 44: project.service.v1.ProjectService.UpdateCollectProject:output_type -> project.service.v1.CollectProjectResponse
	13, // 45: project.service.v1.ProjectService.UpdateProject:output_type -> project.service.v1.UpdateProjectResponse
	28, // 46: project.service.v1.ProjectService.GetLogBySelfProject:output_type -> project.service.v1.ProjectLogResponse
	30, // 47: project.service.v1.ProjectService.NodeList:output_type -> project.service.v1.ProjectNodeResponseMessage
	31, // 48: project.service.v1.ProjectService.FindProjectByMemberId:output_type -> project.service.v1.FindProjectByMemberIdResponse
	14, // 49: project.service.v1.ProjectService.QuitProject:output_type -> project.service.v1.QuitProjectResponse
	15, // 50: project.service.v1.ProjectService.ArchiveProject:output_type -> project.service.v1.ArchiveProjectResponse
	16, // 51: project.service.v1.ProjectService.RecoveryArchive:output_type -> project.service.v1.RecoveryArchiveResponse
	17, // 52: project.service.v1.ProjectService.DeleteProject:output_type -> project.service.v1.DeleteProjectResponse
	19, // 53: project.service.v1.ProjectService.ProjectAnalysis:output_type -> project.service.v1.ProjectAnalysisResponse
	20, // 54: project.service.v1.ProjectService.SearchInviteMember:output_type -> project.service.v1.SearchInviteMemberResponse
	22, // 55: project.service.v1.ProjectService.InviteMember:output_type -> project.service.v1.InviteMemberResponse
	23, // 56: project.service.v1.ProjectService.JoinByInviteLink:output_type -> project.service.v1.JoinByInviteLinkResponse
	24, // 57: project.service.v1.ProjectService.RemoveMember:output_type -> project.service.v1.RemoveMemberResponse
	25, // 58: project.service.v1.ProjectService.ListForInvite:output_type -> project.service.v1.ListForInviteResponse
