...
const (
	...
	AccountService_SaveAccount_FullMethodName = "/account.service.v1.AccountService/SaveAccount"
)
...
type AccountServiceClient interface {
	...
	SaveAccount(ctx context.Context, in *AccountReqMessage, opts ...grpc.CallOption) (*AccountResponse, error)
}
...
func (c *accountServiceClient) SaveAccount(ctx context.Context, in *AccountReqMessage, opts ...grpc.CallOption) (*AccountResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(AccountResponse)
...
type AccountServiceServer interface {
	...
	SaveAccount(context.Context, *AccountReqMessage) (*AccountResponse, error)
...
func (UnimplementedAccountServiceServer) SaveAccount(context.Context, *AccountReqMessage) (*AccountResponse, error) {
...
func _AccountService_SaveAccount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AccountServiceServer).SaveAccount(ctx, req.(*AccountReqMessage))
	}
	return interceptor(ctx, in, info, handler)
}
