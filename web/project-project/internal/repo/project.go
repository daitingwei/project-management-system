...
type ProjectRepo interface {
	...
	DeleteProjectMember(ctx context.Context, projectCode int64, memberId int64) error
	UpdateArchive(ctx context.Context, projectCode int64, archive int) error
	DeleteProject(ctx context.Context, projectCode int64) error
}

type ProjectTemplateRepo interface {
	SaveProjectTemplate(ctx context.Context, pt *data.ProjectTemplate) error
	UpdateProjectTemplate(ctx context.Context, pt *data.ProjectTemplate) error
	Delete(ctx context.Context, code string) error
	FindProjectTemplateByCode(ctx context.Context, code string) (*data.ProjectTemplate, error)
